...
var handleErrorTable = function (response) {
    ...
    if (code == 500) {
        ...
        if (localStorage.getItem("role") == 1) {
            ...
            let html = `
                <tr class="odd"><td colspan="6" class="dataTables_empty" valign="top">Tak ada data yang tersedia pada tabel ini</td></tr>
            `;
            $("#tbl-rekrutmen tbody").html(html);
        }

        if (localStorage.getItem("role") == 2) {
            $("#history_processing").addClass("d-none");
            let htmlUser = `
                <tr class="odd"><td colspan="5" class="dataTables_empty" valign="top">Tak ada data yang tersedia pada tabel ini</td></tr>
            `;
            $("#history tbody").html(htmlUser);
        }
