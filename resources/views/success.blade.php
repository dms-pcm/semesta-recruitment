        ...
        <div class="row d-flex justify-content-center min-vh-100 pt-5 pb-5">
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                ...
                <div class="card-body p-4 p-sm-5">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="{{asset('fe/assets/img/success.png')}}" style="width:100%;" alt="Email" width="100">
                        <h4 class="mb-2" style="font-family: Poppins">Email Kamu Berhasil Diverifikasi!!</h4>
